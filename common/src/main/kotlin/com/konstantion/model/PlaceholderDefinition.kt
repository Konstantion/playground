...
sealed interface PlaceholderDefinition<T> where T : PlaceholderValue {
  ...
  sealed interface RandomOneOf<T> : PlaceholderDefinition<T> where T : PlaceholderValue {
    ...
    private data class I32(
      ...
      override fun options(): List<PlaceholderValue.I32> = options.map(PlaceholderValue::I32)
    }
    ...
    private data class Str(
      ...
      override fun options(): List<PlaceholderValue.Str> = options.map(PlaceholderValue::Str)
    }
  ...
  data class I32Range(
    ...
    override fun value(): PlaceholderValue.I32 = PlaceholderValue.I32((start..end).random())
  }
